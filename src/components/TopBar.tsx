...
export function TopBar() {
  ...
  return (
    <header className="sticky top-0 bg-surface/95 dark:bg-dark-surface/95 z-40 border-b border-outline-variant dark:border-white/10 backdrop-blur-md transition-colors duration-300">
      <div className="flex justify-between items-center px-6 md:px-8 py-4 mx-auto max-w-[1200px]">
        <div>
          <Link to="/" className="font-label-sm text-label-sm text-primary dark:text-primary-fixed-dim font-semibold hover:opacity-80 no-underline">Artogue</Link>
        ...
        <div className="flex items-center gap-4 md:gap-6">
          <div className="relative hidden md:block">
            <span className="material-symbols-outlined absolute left-3 top-1/2 -translate-y-1/2 text-outline dark:text-outline-variant text-[20px]">search</span>
            <input
              className="pl-10 pr-4 py-2 bg-surface-container-lowest dark:bg-dark-card border border-outline-variant dark:border-white/10 rounded-full text-body-sm focus:outline-none focus:ring-2 focus:ring-primary/20 w-48 lg:w-64 dark:text-white transition-colors duration-300"
